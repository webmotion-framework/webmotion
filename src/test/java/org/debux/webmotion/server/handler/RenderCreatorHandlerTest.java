...
import org.debux.webmotion.server.call.Render.RenderContent;
import org.debux.webmotion.server.call.Render.RenderJson;
import org.debux.webmotion.server.call.Render.RenderJsonP;
import org.debux.webmotion.server.call.Render.RenderXml;
...
public class RenderCreatorHandlerTest {
    ...
    protected RenderCreatorHandler handler;
    
    @BeforeMethod
    public void createHandler() {
        handler = new RenderCreatorHandler();
    }
    ...
    public void testRenderContent() throws IOException, ServletException {
        ...
        Call call = new CallWrapper(render);
        handler.renderContent(null, call);
