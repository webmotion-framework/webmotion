...
jru : Suppression des liens hide/skip/close, toc est toujours afficher.
*/
  ...
  generate: function() {
    ...
    if (tocparent) {
      ...
      for (var i=0; i<classes.length; i++) {
        ...
        } else if (classes[i].match(/^generate_for_[a-z_]+$/)) {
    ...
    } else if(generate_for != '') {
        top_node = document.getElementById(generate_for);
    } else {
