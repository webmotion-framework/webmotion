 ...
 * @author jruchaud
 */
public class WebMotionService implements ServletContextListener {
    
    private static final long serialVersionUID = 1L;

    private static final Logger log = LoggerFactory.getLogger(WebMotionService.class);
    ...
    public static final String SERVICE_ATTRIBUTE_NAME = "org.debux.webmotion.server.service";
    ...
    public void contextInitialized(ServletContextEvent servletContextEvent) {
        ...
        // Store the listener
        servletContext.setAttribute(SERVICE_ATTRIBUTE_NAME, this);
    }
