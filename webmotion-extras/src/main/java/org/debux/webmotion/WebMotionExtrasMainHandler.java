 ...
 * @author julien
 */
public class WebMotionExtrasMainHandler extends WebMotionMainHandler {

    private static final Logger log = LoggerFactory.getLogger(WebMotionExtrasMainHandler.class);
